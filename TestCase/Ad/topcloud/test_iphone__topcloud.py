...
filename = path_dir + r'/Yaml/topcloud/iphone红包雨'
...
def test_diff(data):
    ...
    if data['isJson'] == 1:
        ...
        assert DeepDiff(base_json, cur_json, exclude_paths=["root['impid']","root['ads'][0]['ad'][0]['ext']['reqtime']","root['ads'][0]['ad'][0]['ext']['servertime']"]) == {}
    else:
